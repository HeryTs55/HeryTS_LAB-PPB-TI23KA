...
const friends = [
    ...
    { id: '8', name: 'Rafi', fullname: 'Rafi Nugraha', gender: 'M' },
    { id: '9', name: 'Bagas', fullname: 'Bagas Saputra', gender: 'M' },
    { id: '10', name: 'Dinda', fullname: 'Dinda Ayu Lestari', gender: 'F' },
    { id: '11', name: 'Ilham', fullname: 'Ilham Prakoso', gender: 'M' },
    { id: '12', name: 'Melani', fullname: 'Melani Kusuma', gender: 'F' },
    { id: '13', name: 'Nadya', fullname: 'Nadya Prameswari', gender: 'F' },
    { id: '14', name: 'Rizky', fullname: 'Rizky Maulana', gender: 'M' },
];
