...
const stories = [
  ...
  { id: '8', name: 'Rafi', gender: 'M' },
  { id: '9', name: 'Bagas', gender: 'M' },
  { id: '10', name: 'Dinda', gender: 'F' },
  { id: '11', name: 'Ilham', gender: 'M' },
  { id: '12', name: 'Melani', gender: 'F' },
  { id: '13', name: 'Nadya', gender: 'F' }, 
  { id: '14', name: 'Rizky', gender: 'M' },
];
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.storiesWrapper}>
        ...
        <View style={styles.postContainer}>
            ...
            <Image source={require('../assets/icons/post.jpg')} style={styles.postImage} />
        </View>
    </ScrollView>
  );
};
